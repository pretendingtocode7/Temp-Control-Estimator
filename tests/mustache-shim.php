<?php
/**
 * Minimal Mustache_Engine shim for test environments where composer install isn't available.
 *
 * Covers the subset our templates use:
 ...
 *
 * NOT a Mustache spec-conforming implementation. Real production uses bobthecow/mustache.php
 * via composer. This shim exists solely so tests can run in sandboxed environments without
 * package-repo access.
 */
